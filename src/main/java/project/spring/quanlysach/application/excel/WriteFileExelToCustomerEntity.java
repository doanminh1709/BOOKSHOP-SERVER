...
@Getter
@Setter
public class WriteFileExelToCustomerEntity implements IExcelFile {

    List<Product> productList;
    private XSSFWorkbook workbook;
    private XSSFSheet sheet;

    public WriteFileExelToCustomerEntity(List<Product> productList) {
    ...
    public void export(HttpServletResponse response) throws IOException {
        writeTitle();
        writeData();
        if (response != null) {//has request print file from client
