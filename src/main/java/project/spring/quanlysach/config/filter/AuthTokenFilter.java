package project.spring.quanlysach.config.filter;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try {
            ...
            if (jwt != null && jwtUtils.validationToken(jwt)) {
                String username = jwtUtils.getUserByToken(jwt);
                UserDetails userDetails = customerDetailServiceImp.loadUserByUsername(username);
